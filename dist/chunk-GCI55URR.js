...
var spacingSchema = z.enum([
  "compact",
  "default",
  "comfortable",
  "spacious"
]);
var fontSourceSchema = z.object({
...
var fontRoleSchema = z.union([z.string(), fontSourceSchema]);
...
var componentTokensSchema = z.object({
  card: z.object({
...
var shadowSchema = z.enum(["none", "xs", "sm", "md", "lg", "xl"]);
var globalTokensSchema = z.object({
  shadow: shadowSchema.optional(),
  durations: z.object({
    instant: z.number().min(0).max(200).optional(),
    fast: z.number().min(50).max(500).optional(),
    normal: z.number().min(100).max(1e3).optional(),
    slow: z.number().min(200).max(2e3).optional()
  }).strict().optional(),
  easings: z.object({
...
var flavorOverrideSchema = z.object({
